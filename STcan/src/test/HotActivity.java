...
public class HotActivity extends Activity {
	...
	private final BroadcastReceiver mGattUpdateReceiver = new BroadcastReceiver() {
		...
		public void onReceive(Context context, Intent intent) {
			Log.d("HA", "into BroadcastReceiver.");
	...
	private final ServiceConnection mServiceConnection = new ServiceConnection() {
		...
		public void onServiceConnected(ComponentName componentName, IBinder service) {
			...
			Log.d("HA", "into ServiceConnected of ServiceConnection.");
		}

		@Override
		public void onServiceDisconnected(ComponentName componentName) {
			mBluetoothLeService = null;
			Log.d("HA", "into ServiceDisconnected of ServiceConnection.");
		}
	};
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		melapsedtime = (TextView) findViewById(R.id.hot_elapsedtime); 
		((TextView) findViewById(R.id.hot_address)).setText(ReadyActivity.mDeviceAddress);
		mConnectionState = (TextView) findViewById(R.id.hot_state);
		mPqrst = (TextView) findViewById(R.id.hot_pqrst);
		mRri = (TextView) findViewById(R.id.hot_rri);

		// add by me
		mshtpNN50 = (TextView) findViewById(R.id.hot_shtpnn);
		mlngpNN50 = (TextView) findViewById(R.id.hot_lngpnn);


		finish = (Button) findViewById(R.id.hot_finish);
		...
		ecg = new ECG(file_date, FileString.MODE.HOT);
		LinearLayout rLayout = (LinearLayout)findViewById(R.id.hot_root);
	...
	protected void onDestroy() {
		...
		try{
			ecg.close();
			Log.d("HA", "file closed.");
		}catch(Exception e){
			Log.e("HA", e.getMessage() + " file closing failed...");
		}
	}
