...
public class Disp_score2 : MonoBehaviour {
	...
	public int food_cal1 = 6;
	public int food_cal2 = 85;
	public int food_cal3 = 160;
	public int food_cal4 = 352;
	public int food_cal5 = 200;
	...
	void Start () {
		...
		text1.text = " × " + Food_Count2.food_count1;
		text2.text = " × " + Food_Count2.food_count2;
		text3.text = " × " + Food_Count2.food_count3;
		text4.text = " × " + Food_Count2.food_count4;
		text5.text = " × " + Food_Count2.food_count5;
	...
	void caliculation(){
		total_cal = food_cal1 * Food_Count2.food_count1 + food_cal2 * Food_Count2.food_count2 + food_cal3 * Food_Count2.food_count3 + food_cal4 * Food_Count2.food_count4 + food_cal5 * Food_Count2.food_count5;
